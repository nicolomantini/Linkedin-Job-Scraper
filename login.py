...
class LoginGUI(tk.Tk):
    ...
    def __init__(self,*args, **kwargs):
        ...
        label = tk.Label(self, text="LinkedIn Jobs Scraper", font=self.title_font)
...
class PageSix(tk.Frame):
    ...
    def summary (self):
        label = tk.Label(self, text="Ready to start Scraping?", font=self.controller.subtitle_font)
        label.grid(row=2,columnspan = 2, pady=10)
